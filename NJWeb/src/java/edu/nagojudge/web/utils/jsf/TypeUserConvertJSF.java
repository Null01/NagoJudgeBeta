 ...
 */
@FacesConverter("typeUserConvertJSF")
public class TypeUserConvertJSF extends AbstractConvertJsf implements Converter {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return String.valueOf(((TypeUser) value).getIdType());
        }
    }
