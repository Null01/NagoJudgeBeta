...
public interface IResourcesPath {
    ...
    public final String PATH_VIEW_PROBLEMS = File.separatorChar + "live" + File.separatorChar + "now" + File.separatorChar + "external" + File.separatorChar + "problems";

    public final String ENDPOINT_CONTEST_LIVE = "/notifyAddSubmitToContest";
